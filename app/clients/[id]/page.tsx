          ...
          {activeTab === 'details' ? (
            <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
              ...
              <div className="xl:col-span-3 space-y-6">
                ...
                {false && ClientDisplayUtils.hasValue(ClientDisplayUtils.getSkorUserId(client)) && (
                  <div className="card">
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="text-center">
                          ...
                          {photoLoading.selfie ? (
                            ...
                            <img
                              src={photoPaths.selfie ?? undefined}
                              alt="Selfie Photo"
                              className="w-full h-48 object-cover rounded-lg border cursor-pointer hover:opacity-90 transition-opacity"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      {ClientDisplayUtils.hasValue(client.EC1_Name) && (
                        <div className="p-3 bg-gray-50 rounded-lg">
                          ...
                          <div className="font-medium text-gray-900">{client.EC1_Name}</div>
                          {client.EC1_Relation && (
                            <div className="text-xs text-gray-600">{client.EC1_Relation}</div>
                          )}
                          {client.EC1_Phone && (
                            <div className="text-sm text-gray-700 mt-1">
                              <div className="flex gap-2">
                                <span>{client.EC1_Phone}</span>
                                <button
                                  onClick={(e) => {
                                    e.stopPropagation();
                                    handleCallPhone(client.EC1_Phone!);
                                  }}
                                ...
                                <button
                                  onClick={(e) => {
                                    e.stopPropagation();
                                    handleWhatsApp(client.EC1_Phone!);
                                  }}
                                  className="text-green-600 hover:text-green-800"
                                  title="WhatsApp"
                                >
                      ...
                      {ClientDisplayUtils.hasValue(client.EC2_Name) && (
                        <div className="p-3 bg-gray-50 rounded-lg">
                          ...
                          <div className="font-medium text-gray-900">{client.EC2_Name}</div>
                          {client.EC2_Relation && (
                            <div className="text-xs text-gray-600">{client.EC2_Relation}</div>
                          )}
                          {client.EC2_Phone && (
                            <div className="text-sm text-gray-700 mt-1">
                              <div className="flex gap-2">
                                <span>{client.EC2_Phone}</span>
                                <button
                                  onClick={(e) => {
                                    e.stopPropagation();
                                    handleCallPhone(client.EC2_Phone!);
                                  }}
                                  className="text-green-600 hover:text-green-800"
                                  title="Call"
                                >
                                ...
                                <button
                                  onClick={(e) => {
                                    e.stopPropagation();
                                    handleWhatsApp(client.EC2_Phone!);
                                  }}
                                  className="text-green-600 hover:text-green-800"
                                  title="WhatsApp"
                                >
